NEXT_PROVIDER_VERSION=1.1.0

openbsd_amd64:
	GOOS=openbsd GOARCH=amd64 go build -o terraform-provider-schemaregistry_v$(NEXT_PROVIDER_VERSION)
...
freebsd_amd64:
	GOOS=freebsd GOARCH=amd64 go build -o terraform-provider-schemaregistry_v$(NEXT_PROVIDER_VERSION)
...
linux_amd64:
	GOOS=linux GOARCH=amd64 go build -o terraform-provider-schemaregistry_v$(NEXT_PROVIDER_VERSION)
...
darwin_amd64:
	GOOS=darwin GOARCH=amd64 go build -o terraform-provider-schemaregistry_v$(NEXT_PROVIDER_VERSION)
